 ...
 * tier, dedupes against KV, sends a tiered alert email, and records it. It also
 * reads the wallet's stale datasets from the subgraph and emails once about
 * each newly inactive one.
 *
